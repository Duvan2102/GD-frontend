...
export class Aprobaciones implements OnInit {
  ListaDeAprobaciones = [
    ...
    { tipo: 'VIATICOS', id: '014', fechaCreacion: '2025-03-26T12:00:00', usuarioCreador: 'USUARIO.HELISA', cargo: 'EMPLEADO', ultimaActualizacion: '2025-03-27T13:00:00', estado: 'APROBADOS', aprobadores: ['AS'], prioridad: true },
    { tipo: 'VIATICOS', id: '015', fechaCreacion: '2025-03-26T12:00:00', usuarioCreador: 'USUARIO.HELISA', cargo: 'EMPLEADO', ultimaActualizacion: '2025-03-27T13:00:00', estado: 'APROBADOS', aprobadores: ['LC', 'JS'], prioridad: true },
    { tipo: 'REQUISICIONES', id: '016', fechaCreacion: '2025-03-26T12:00:00', usuarioCreador: 'USUARIO.HELISA', cargo: 'EMPLEADO', ultimaActualizacion: '2025-03-27T13:00:00', estado: 'APROBADOS', aprobadores: ['LC', 'JS'], prioridad: false },
    ...
    { tipo: 'REQUISICIONES', id: '018', fechaCreacion: '2025-03-26T09:45:00', usuarioCreador: 'CARLOS.DIAZ', cargo: 'JEFE DE ÁREA', ultimaActualizacion: '2025-03-27T14:30:00', estado: 'APROBADOS', aprobadores: ['LC', 'JS'], prioridad: true },
    ...
    { tipo: 'VIATICOS', id: '021', fechaCreacion: '2025-03-29T15:30:00', usuarioCreador: 'LUISA.MORA', cargo: 'SUPERVISOR', ultimaActualizacion: '2025-03-30T09:00:00', estado: 'APROBADOS', aprobadores: ['JS'], prioridad: false },
    { tipo: 'REQUISICIONES', id: '022', fechaCreacion: '2025-03-30T07:50:00', usuarioCreador: 'FERNANDO.TORO', cargo: 'JEFE DE ÁREA', ultimaActualizacion: '2025-03-30T17:00:00', estado: 'APROBADOS', aprobadores: ['JS', 'LC'], prioridad: true },
    ...
    { tipo: 'VIATICOS', id: '025', fechaCreacion: '2025-04-03T09:20:00', usuarioCreador: 'PATRICIA.OLIVER', cargo: 'SUPERVISOR', ultimaActualizacion: '2025-04-04T10:00:00', estado: 'APROBADOS', aprobadores: ['LC'], prioridad: false },

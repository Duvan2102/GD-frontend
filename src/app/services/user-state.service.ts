...
export class UserStateService {
  ...
  private _pendingAction: 'activar' | 'inactivar' | 'eliminarQR' | 'rechazar' | 'marcarEliminado' | null = null;

  setPendingOperation(user: Usuario, action: 'activar' | 'inactivar' | 'eliminarQR' | 'rechazar' | 'marcarEliminado'): void {
